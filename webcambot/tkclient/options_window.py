...
class OptionsWindow (Toplevel):
    ...
    def __init__(self,*args,**kwargs):
        ...
        Label(self.angleFrame,text="Pan").grid(row=3,column=0,sticky=W)
        ...
        self.panFrame.grid(row=3,column=1,sticky=W)

        Label(self.angleFrame,text="Tilt").grid(row=4,column=0,sticky=W)
        ...
        self.tiltFrame.grid(row=4,column=1,sticky=W)
